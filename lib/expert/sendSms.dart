...
class _SendMessageState extends State<SendMessage> {
  ...
  getUserInfo() async {
    ...
    await Firestore.instance.collection("experts").document(widget.userId).get().then((value) {
      setState(() {
  ...
  sendMessage() async {
    ...
    {
      await Firestore.instance.collection("experts").document(widget.userId).collection("messages").add({
