...
class AdminChatDetails extends StatefulWidget {

  final MyMessage message;

  AdminChatDetails({this.message});

  @override
  _AdminChatDetailsState createState() => _AdminChatDetailsState();
}

class _AdminChatDetailsState extends State<AdminChatDetails> {
