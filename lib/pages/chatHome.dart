...
class _ChatHomeState extends State<ChatHome> {
  ...
  final MessageDBManager messageDBManager = MessageDBManager();
  bool loading = false;
            ...
            else
              {
                return ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    ...
                    bool isMe = message.senderID == MyPoultry.sharedPreferences.getString(MyPoultry.userUID);
                    ...
                    return Column(
                      ...
                      children: [
                        ListTile(
                          onTap: () {
                            Route route = MaterialPageRoute(builder: (context)=> ChatDetails(userId: isMe ? message.receiverID : message.senderID,));
                            Navigator.push(context, route);
                          },
                          leading: CircleAvatar(
                            backgroundImage: NetworkImage(message.receiverPhotoUrl),
                            radius: 30.0,
                          ),
                          title: Text(message.receiverName.trimRight(), maxLines: 1, overflow: TextOverflow.ellipsis, style: GoogleFonts.fredokaOne(color: Colors.black, fontSize: 17.0),),
                          subtitle: Padding(
